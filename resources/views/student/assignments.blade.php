<x-app-layout>
    ...
    <div class="py-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="{ q:'', tag:'all' }">
            ...
            <table class="min-w-full text-sm">
                ...
                <tbody class="divide-y">
                    ...
                    @forelse($assignments as $a)
                        ...
                        <tr
                            x-show="(q==='' || '{{ strtolower($a->title.' '.$a->description.' '.$a->key) }}'.includes(q.toLowerCase()))
                        ...
                        >
                            ...
                            <td class="px-4 py-3">
                                <span class="inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium {{ $cls }}">
                                    {{ $label }}
                                </span>
                            </td>
                            <td class="px-4 py-3">
                        ...
                        <tr>
                            <td colspan="4" class="px-4 py-10">
                                <div class="text-center text-gray-500">
                                    <div class="mx-auto mb-2 size-10 rounded-full bg-indigo-50 text-indigo-700 flex items-center justify-center ring-1 ring-indigo-200">🔎</div>
                                    Tidak ada soal. Jalankan seeder:
                                    <span class="font-mono text-xs bg-gray-100 px-2 py-1 rounded">php artisan db:seed --class=AssignmentSeeder</span>
                                </div>
                            </td>
                        </tr>
                    @endforelse
        ...
        <p class="text-xs text-gray-400 mt-4">
            Tip: Mulai dari SQLi, lanjut XSS, lalu IDOR. Gunakan <span class="font-mono rounded bg-gray-100 px-1">prepared statements</span> & output escaping.
        </p>
    </div>
</x-app-layout>
